...
function profiles_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Domain,Country,AreaCode,InUse",
    "PermittedFields" => "ID,Description,Domain,Country,AreaCode,InUse"
  );
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New system profile added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
function profiles_add ( $buffer, $parameters)
{
  ...
  if ( ! array_key_exists ( "Blocked", $parameters) || ! is_array ( $parameters["Blockeds"]))
  {
    if ( array_key_exists ( "Blocked", $parameters) && ! empty ( $parameters["Blockeds"]))
    {
  ...
  if ( ! array_key_exists ( "Gateways", $parameters) || ! is_array ( $parameters["Gateways"]))
  {
    if ( array_key_exists ( "Gateways", $parameters) && ! empty ( $parameters["Gateways"]))
    {
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system profile was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
