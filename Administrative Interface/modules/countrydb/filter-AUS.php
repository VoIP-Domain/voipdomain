...
function e164_identify_country_AUS ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $operator)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "61", "NDC" => (string) $prefix, "Country" => "Australia", "Area" => "", "City" => "", "Operator" => $operator, "SN" => substr ( $parameters["Number"], 3 + strlen ( $prefix)), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => "(0" . substr ( $parameters["Number"], 3, 1) . ") " . substr ( $parameters["Number"], 4, 4) . " " . substr ( $parameters["Number"], 8), "International" => "+61 " . substr ( $parameters["Number"], 3, 1) . " " . substr ( $parameters["Number"], 4, 4) . " " . substr ( $parameters["Number"], 8))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "61", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Australia", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_VOIP, "CallFormats" => array ( "Local" => "(0" . substr ( $parameters["Number"], 3, 1) . ") " . substr ( $parameters["Number"], 4, 4) . " " . substr ( $parameters["Number"], 8), "International" => "+61 " . substr ( $parameters["Number"], 3, 1) . " " . substr ( $parameters["Number"], 4, 4) . " " . substr ( $parameters["Number"], 8))));
  }
