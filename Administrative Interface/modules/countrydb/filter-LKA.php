...
function e164_identify_country_LKA ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $operator)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "94", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Sri Lanka", "Area" => "", "City" => "", "Operator" => $operator, "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => "0" . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5), "International" => "+94 " . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5))));
    }
  }
  ...
  $operators = array (
    "9" => array ( "Operator" => "Tritel", "Type" => VD_CALLENDPOINT_PAYPHONE),
    "8" => array ( "Operator" => "", "Type" => VD_CALLENDPOINT_LANDLINE),
    "7" => array ( "Operator" => "Dialog", "Type" => VD_CALLENDPOINT_FMC),
    "6" => array ( "Operator" => "", "Type" => VD_CALLENDPOINT_LANDLINE),
    "5" => array ( "Operator" => "Lanka Bell", "Type" => VD_CALLENDPOINT_FMC),
    "4" => array ( "Operator" => "Dialog", "Type" => VD_CALLENDPOINT_FMC),
    "3" => array ( "Operator" => "SLT-Mobitel", "Type" => VD_CALLENDPOINT_FMC),
    "2" => array ( "Operator" => "SLT-Mobitel", "Type" => VD_CALLENDPOINT_LANDLINE),
    "1" => array ( "Operator" => "", "Type" => VD_CALLENDPOINT_LANDLINE),
    "0" => array ( "Operator" => "Lanka Bell", "Type" => VD_CALLENDPOINT_FMC)
  );
