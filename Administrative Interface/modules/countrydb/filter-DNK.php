...
function e164_identify_country_DNK ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "45", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Denmark", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 2) . "-" . substr ( $parameters["Number"], 5, 2) . "-" . substr ( $parameters["Number"], 7, 2) . "-" . substr ( $parameters["Number"], 9), "International" => "+45 " . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5, 2) . " " . substr ( $parameters["Number"], 7, 2) . " " . substr ( $parameters["Number"], 9))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "45", "NDC" => substr ( $parameters["Number"], 4, 2), "Country" => "Denmark", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_SPECIAL, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 2) . "-" . substr ( $parameters["Number"], 5, 2) . "-" . substr ( $parameters["Number"], 7, 2) . "-" . substr ( $parameters["Number"], 9), "International" => "+45 " . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5, 2) . " " . substr ( $parameters["Number"], 7, 2) . " " . substr ( $parameters["Number"], 9))));
  }
