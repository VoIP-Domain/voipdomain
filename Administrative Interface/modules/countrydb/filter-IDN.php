...
function e164_identify_country_IDN ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $data)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "62", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Indonesia", "Area" => $data["area"], "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => "(0" . substr ( $parameters["Number"], 3, 2) . ")-" . substr ( $parameters["Number"], 5, 4) . "-" . substr ( $parameters["Number"], 9), "International" => "+62 " . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5, 4) . " " . substr ( $parameters["Number"], 9))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "62", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Indonesia", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_PAGING, "CallFormats" => array ( "Local" => "(0" . substr ( $parameters["Number"], 3, 2) . ")-" . substr ( $parameters["Number"], 5, 4) . "-" . substr ( $parameters["Number"], 9), "International" => "+62 " . substr ( $parameters["Number"], 3, 2) . " " . substr ( $parameters["Number"], 5, 4) . " " . substr ( $parameters["Number"], 9))));
  }
