...
function e164_identify_country_TTO ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $operator)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "1868", "NDC" => substr ( $parameters["Number"], 5, 3), "Country" => "Trinidad and Tobago", "Area" => "", "City" => "", "Operator" => $operator, "SN" => substr ( $parameters["Number"], 8), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 5, 3) . " " . substr ( $parameters["Number"], 8), "International" => "+1 868 " . substr ( $parameters["Number"], 5, 3) . " " . substr ( $parameters["Number"], 8))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "1868", "NDC" => substr ( $parameters["Number"], 5, 3), "Country" => "Trinidad and Tobago", "Area" => "", "City" => "", "Operator" => "Telecommunications Services of Trinidad and Tobago (TSTT)", "SN" => substr ( $parameters["Number"], 8), "Type" => VD_CALLENDPOINT_VOICEMAIL, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 5, 3) . " " . substr ( $parameters["Number"], 8), "International" => "+1 868 " . substr ( $parameters["Number"], 5, 3) . " " . substr ( $parameters["Number"], 8))));
  }
