...
function e164_identify_country_AND ( $buffer, $parameters)
{
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "376", "NDC" => "1", "Country" => "Andorra", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_TOLLFREE, "CallFormats" => array ( "Local" => "1 802 " . substr ( $parameters["Number"], 8), "International" => "+376 1 802 " . substr ( $parameters["Number"], 8))));
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "376", "NDC" => "690", "Country" => "Andorra", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 7), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => "690 " . substr ( $parameters["Number"], 7, 3) . " " . substr ( $parameters["Number"], 10, 3), "International" => "+376 690 " . substr ( $parameters["Number"], 7, 3) . " " . substr ( $parameters["Number"], 10, 3))));
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "376", "NDC" => substr ( $parameters["Number"], 4, 3), "Country" => "Andorra", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 7), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 4, 3) . " " . substr ( $parameters["Number"], 7), "International" => "+376 " . substr ( $parameters["Number"], 4, 3) . " " . substr ( $parameters["Number"], 7))));
  }
