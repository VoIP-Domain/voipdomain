...
function e164_identify_country_NG_ATT ( $buffer, $parameters)
{
   ...
   */
  return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "88237", "NDC" => "", "Country" => "AT&T Cingular Wireless Network", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_SATELLITE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 6), "International" => "+882 37 " . substr ( $parameters["Number"], 6))));
}
?>
