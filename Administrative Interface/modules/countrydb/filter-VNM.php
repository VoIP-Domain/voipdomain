...
function e164_identify_country_VNM ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $operator)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "84", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Viet Nam", "Area" => "", "City" => "", "Operator" => $operator, "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8), "International" => "+84 " . substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "84", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Viet Nam", "Area" => $area, "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_VSAT, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8), "International" => "+84 " . substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8))));
  }
