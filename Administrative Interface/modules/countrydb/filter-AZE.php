...
function e164_identify_country_AZE ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $operator)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "994", "NDC" => substr ( $parameters["Number"], 4, 2), "Country" => "Azerbaijan", "Area" => "", "City" => "", "Operator" => $operator, "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 4, 2) . ") " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9), "International" => "+994 " . substr ( $parameters["Number"], 4, 2) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "994", "NDC" => substr ( $parameters["Number"], 4, 2), "Country" => "Azerbaijan", "Area" => "", "City" => "", "Operator" => "Avirtel LLC", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_LANDLINE, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 4, 2) . ") " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9, 4), "International" => "+994 " . substr ( $parameters["Number"], 4, 2) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9))));
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "994", "NDC" => substr ( $parameters["Number"], 4, 2), "Country" => "Azerbaijan", "Area" => "", "City" => "", "Operator" => "Delta Telecom Ltd LLC", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_LANDLINE, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 4, 2) . ") " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9, 4), "International" => "+994 " . substr ( $parameters["Number"], 4, 2) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9))));
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "994", "NDC" => substr ( $parameters["Number"], 4, 2), "Country" => "Azerbaijan", "Area" => "", "City" => "", "Operator" => "Naxtel network", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_LANDLINE, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 4, 2) . ") " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9, 4), "International" => "+994 " . substr ( $parameters["Number"], 4, 2) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9))));
  }
