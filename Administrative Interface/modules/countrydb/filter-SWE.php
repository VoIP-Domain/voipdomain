...
function e164_identify_country_SWE ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "46", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Sweden", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8), "International" => "+46 " . substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8))));
    }
  }
  ...
  foreach ( $prefixes as $prefix)
  {
    if ( strlen ( $parameters["Number"]) == 12 && (int) substr ( $parameters["Number"], 3, strlen ( $prefix)) == $prefix)
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "46", "NDC" => substr ( $parameters["Number"], 3, 2), "Country" => "Sweden", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_PAGING, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8), "International" => "+46 " . substr ( $parameters["Number"], 3, 5) . " " . substr ( $parameters["Number"], 8))));
    }
  }
  ...
  foreach ( $prefixes as $prefix)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "46", "NDC" => $prefix, "Country" => "Sweden", "Area" => $data["Area"], "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 3 + strlen ( $prefix)), "Type" => VD_CALLENDPOINT_SPECIAL, "CallFormats" => array ( "Local" => trim ( substr ( $parameters["Number"], 3, strlen ( $prefix)) . " " . substr ( $parameters["Number"], 3 + strlen ( $prefix))), "International" => "+46 " . substr ( $parameters["Number"], 3, strlen ( $prefix)) . " " . substr ( $parameters["Number"], 3 + strlen ( $prefix)))));
    }
  }
