...
function e164_identify_country_NG_BCA ( $buffer, $parameters)
{
   ...
   */
  return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "88234", "NDC" => "", "Country" => "BebbiCell AG", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_SATELLITE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 6), "International" => "+882 34 " . substr ( $parameters["Number"], 6))));
}
?>
