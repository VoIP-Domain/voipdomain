...
function e164_identify_country_USA ( $buffer, $parameters)
{
  ...
  switch ( substr ( $parameters["Number"], 2, 3))
  {
    ...
    case "888":
    case "889":
      return array_merge_recursive ( is_array ( $buffer) ? $buffer : array (), array ( "CC" => "1", "NDC" => substr ( $parameters["Number"], 2, 3), "Country" => "United States of America", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_TOLLFREE, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 2, 3) . ") " . substr ( $parameters["Number"], 5, 3) . "-" . substr ( $parameters["Number"], 8), "International" => "+1 " . substr ( $parameters["Number"], 2, 3) . " " . substr ( $parameters["Number"], 5))));
      break;
  }
  ...
  {
    return array_merge_recursive ( is_array ( $buffer) ? $buffer : array (), array ( "CC" => "1", "NDC" => substr ( $parameters["Number"], 2, 3), "Country" => "United States of America", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 5), "Type" => VD_CALLENDPOINT_SPECIAL, "CallFormats" => array ( "Local" => "(" . substr ( $parameters["Number"], 2, 3) . ") " . substr ( $parameters["Number"], 5, 3) . "-" . substr ( $parameters["Number"], 8), "International" => "+1 " . substr ( $parameters["Number"], 2, 3) . " " . substr ( $parameters["Number"], 5))));
  }
