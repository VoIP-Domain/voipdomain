...
function e164_identify_country_SGP ( $buffer, $parameters)
{
  ...
  foreach ( $prefixes as $prefix => $data)
  {
    ...
    {
      return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "65", "NDC" => substr ( $parameters["Number"], 3, 1), "Country" => "Singapore", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 4), "Type" => VD_CALLENDPOINT_MOBILE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 4) . " " . substr ( $parameters["Number"], 7), "International" => "+65 " . substr ( $parameters["Number"], 3, 4) . " " . substr ( $parameters["Number"], 7))));
    }
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "65", "NDC" => substr ( $parameters["Number"], 3, 1), "Country" => "Singapore", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 4), "Type" => VD_CALLENDPOINT_VOIP, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 4) . " " . substr ( $parameters["Number"], 7), "International" => "+65 " . substr ( $parameters["Number"], 3, 4) . " " . substr ( $parameters["Number"], 7))));
  }
  ...
  {
    return array_merge_recursive ( ( is_array ( $buffer) ? $buffer : array ()), array ( "CC" => "65", "NDC" => substr ( $parameters["Number"], 3, 3), "Country" => "Singapore", "Area" => "", "City" => "", "Operator" => "", "SN" => substr ( $parameters["Number"], 6), "Type" => VD_CALLENDPOINT_TOLLFREE, "CallFormats" => array ( "Local" => substr ( $parameters["Number"], 3, 3) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9), "International" => "+65 " . substr ( $parameters["Number"], 3, 3) . " " . substr ( $parameters["Number"], 6, 3) . " " . substr ( $parameters["Number"], 9))));
  }
