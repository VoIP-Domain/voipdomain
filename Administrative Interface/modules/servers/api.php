...
function servers_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Address,Port,Extensions",
    "PermittedFields" => "ID,Description,Address,Port,Backups,Extensions"
  );
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New system server added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
function servers_add ( $buffer, $parameters)
{
  ...
  $parameters["Window"] = array_key_exists ( "Window", $parameters) ? (boolean) $parameters["Window"] : false;
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system server was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
