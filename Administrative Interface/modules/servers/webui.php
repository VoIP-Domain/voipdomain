...
function servers_search_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Server remove") . "', text: '" . __ ( "Server removed successfully!") . "', type: 'success'});\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Server install script") . "', text: '" . __ ( "Server install script generated successfully!") . "', type: 'success'});\n" .
              "  }).fail ( function ( jqXHR, textStatus, errorThrown)\n" .
              "  {\n" .
...
function servers_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('.btn-addntpserver').data ( 'id', 0).on ( 'click', function ( event)\n" .
              ...
              "    success: '" . __ ( "Server added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              ...
              "  formData.Window = $('#server_add_window').prop ( 'checked');\n" .
...
function servers_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('.btn-addntpserver').data ( 'id', 0).on ( 'click', function ( event)\n" .
              ...
              "    success: '" . __ ( "Server changed successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/servers', true);\n" .
              "               }\n" .
              ...
              "  delete ( formData['Backup_Address__X_']);\n" .
              "  delete ( formData['Backup_Port__X_']);\n" .
              "  formData.Window = $('#server_edit_window').prop ( 'checked');\n" .
