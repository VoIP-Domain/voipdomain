...
/**
 * VoIP Domain AudioCodes equipments module filters. This module add the filter
 * calls related to supported AudioCodes equipments.
 *
...
/**
 * Add AudioCodes equipment's filters
 */
framework_add_filter ( "equipments_view_subpages", "equipments_audiocodes_view_subpage");
framework_add_filter ( "equipments_configure_subpages", "equipments_audiocodes_configure_subpage");
 ...
 */
function equipments_audiocodes_view_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
  $extrausersmodels = array ( "310hd", "405hd", "440hd", "450hd");
 ...
 * @return string Output of the generated page
 */
function equipments_audiocodes_configure_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
