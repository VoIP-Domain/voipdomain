...
function costcenters_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove the cost center %s (%s)?"), "<span id=\"costcenter_delete_description\"></span>", "<span id=\"costcenter_delete_code\"></span>") . "</p><input type=\"hidden\" id=\"costcenter_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Cost center remove") . "', text: '" . __ ( "Cost center removed successfully!") . "', type: 'success'});\n" .
...
function costcenters_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#costcenter_add_code').mask ( '0#');\n" .
              ...
              "    success: '" . __ ( "Cost center added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
...
function costcenters_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#costcenter_edit_code').mask ( '0#');\n" .
              ...
              "    success: '" . __ ( "Cost center successfully changed!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/costcenters', true);\n" .
              "               }\n" .
