...
function tokens_permissions_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "Token,Description",
    "PermittedFields" => "Token,Description"
  );
...
function tokens_search ( $buffer, $parameters)
{
   ...
   */
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Expire,ExpireTimestamp",
    "PermittedFields" => "ID,Description,Expire,ExpireTimestamp"
  );
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New system token added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system token was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
