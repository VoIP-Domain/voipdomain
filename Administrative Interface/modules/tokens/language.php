...
i18n_add ( "Are you sure you want to remove token %s (expires %s)?");
i18n_add ( "Token remove");
i18n_add ( "Token removed successfully!");
i18n_add ( "Error removing token!");
i18n_add ( "tokens addition");
...
i18n_add ( "Error adding token!");
i18n_add ( "Token added successfully!");
i18n_add ( "tokens view");
i18n_add ( "Token view");
i18n_add ( "Error retrieving token data!");
i18n_add ( "tokens edition");
i18n_add ( "Token edition");
i18n_add ( "Error changing token!");
i18n_add ( "Token changed successfully!");
i18n_add ( "View token information");
i18n_add ( "Add tokens");
i18n_add ( "The token description is required.");
i18n_add ( "The token is required.");
i18n_add ( "The provided token is invalid.");
i18n_add ( "The token access CIDR is required.");
i18n_add ( "The access CIDR provided is invalid.");
i18n_add ( "At least one permission is required.");
...
i18n_add ( "Token copied to clipboard!");
i18n_add ( "Add a new system token.");
i18n_add ( "An array containing all system permission tokens.");
...
i18n_add ( "New system token added successfully.");
...
i18n_add ( "The system token was successfully updated.");
...
i18n_add ( "Are you sure you want to remove token %s (expires %s)?", "Você tem certeza de que deseja remover o token %s (com validade em %s)?", "pt_BR");
i18n_add ( "Token remove", "Remoção de token", "pt_BR");
i18n_add ( "Token removed successfully!", "Token removido com sucesso!", "pt_BR");
i18n_add ( "Error removing token!", "Erro ao remover token!", "pt_BR");
i18n_add ( "tokens addition", "adição de tokens", "pt_BR");
...
i18n_add ( "Error adding token!", "Erro ao adicionar token!", "pt_BR");
i18n_add ( "Token added successfully!", "Token adicionado com sucesso!", "pt_BR");
i18n_add ( "tokens view", "visualização de tokens", "pt_BR");
i18n_add ( "Token view", "Visualização de token", "pt_BR");
i18n_add ( "Error retrieving token data!", "Erro ao requisitar dados do token!", "pt_BR");
i18n_add ( "tokens edition", "edição de tokens", "pt_BR");
i18n_add ( "Token edition", "Edição de token", "pt_BR");
i18n_add ( "Error changing token!", "Erro ao alterar token!", "pt_BR");
i18n_add ( "Token changed successfully!", "Token alterado com sucesso!", "pt_BR");
...
i18n_add ( "The provided token is invalid.", "O token informado é inválido.", "pt_BR");
i18n_add ( "The token access CIDR is required.", "O CIDR de acesso do token é obrigatório.", "pt_BR");
i18n_add ( "The access CIDR provided is invalid.", "O CIDR de acesso informado é inválido.", "pt_BR");
i18n_add ( "At least one permission is required.", "Ao menos uma permissão é obrigatória.", "pt_BR");
...
i18n_add ( "Token copied to clipboard!", "Token copiado para a área de transferência!", "pt_BR");
i18n_add ( "Add a new system token.", "Adicionar um novo token do sistema", "pt_BR");
i18n_add ( "An array containing all system permission tokens.", "Um array contendo todos os tokens de permissões do sistema.", "pt_BR");
...
i18n_add ( "New system token added successfully.", "Novo token do sistema adicionado com sucesso.", "pt_BR");
...
i18n_add ( "The system token was successfully updated.", "O token do sistema foi atualizado com sucesso.", "pt_BR");
