...
i18n_add ( "Are sure you want to remove the token %s (expires %s)?");
...
i18n_add ( "Token view");
i18n_add ( "Error requesting token data!");
...
i18n_add ( "Are sure you want to remove the token %s (expires %s)?", "Você tem certeza que deseja remover o token %s (com validade em %s)?", "pt_BR");
...
i18n_add ( "Error requesting token data!", "Erro ao requisitar dados do token!", "pt_BR");
