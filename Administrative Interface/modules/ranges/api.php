...
function ranges_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Start,Finish,Server,Extensions",
    "PermittedFields" => "ID,Description,Start,Finish,Server,Extensions"
  );
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New system range was added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system range was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
