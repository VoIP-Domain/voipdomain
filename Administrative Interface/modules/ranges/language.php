...
i18n_add ( "The range start is greater than finish.");
i18n_add ( "The selected server is invalid.");
i18n_add ( "Values override existing range.");
...
i18n_add ( "The range start is greater than finish.", "O início é maior que o final da faixa.", "pt_BR");
i18n_add ( "The selected server is invalid.", "Servidor selecionado é inválido.", "pt_BR");
i18n_add ( "Values override existing range.", "Valores sobrepõe faixa já existente.", "pt_BR");
