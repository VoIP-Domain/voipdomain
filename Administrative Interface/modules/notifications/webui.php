...
function notifications_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove the notification %s (event \"%s\")?", true, false), "<span id=\"notification_delete_description\"></span>", "<span id=\"notification_delete_name\"></span>") . "</p><input type=\"hidden\" id=\"notification_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Notification remove") . "', text: '" . __ ( "Notification removed successfully!") . "', type: 'success'});\n" .
...
function notifications_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#notification_add_event').select2 (\n" .
              ...
              "                  return true;\n" .
              "                },\n" .
              "    success: '" . __ ( "Notification added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              ...
              "    }\n" .
              "  }\n" .
              "  formData.SSL = $('#notification_add_ssl').prop ( 'checked');\n" .
...
function notifications_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#notification_edit_event').select2 (\n" .
              ...
              "                  return true;\n" .
              "                },\n" .
              "    success: '" . __ ( "Notification changed successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/notifications', true);\n" .
              "               }\n" .
              ...
              "    }\n" .
              "  }\n" .
              "  formData.SSL = $('#notification_edit_ssl').prop ( 'checked');\n" .
              "  formData.Validity = moment ( formData.Validity, '" . __ ( "MM/DD/YYYY") . "').isValid () ? moment ( formData.Validity, '" . __ ( "MM/DD/YYYY") . "').format ( 'YYYY-MM-DD') : '';\n" .
