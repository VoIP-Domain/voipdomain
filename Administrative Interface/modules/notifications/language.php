...
i18n_add ( "The validity is required.");
i18n_add ( "Edit notifications");
i18n_add ( "Remove notifications");
i18n_add ( "New call");
i18n_add ( "Event fired when a new call happen at the system.");
i18n_add ( "Extension ringing");
i18n_add ( "Event fired when an extensions start ringing.");
i18n_add ( "Extension answer");
i18n_add ( "Event fired when an extension answer a call.");
i18n_add ( "Extension busy");
i18n_add ( "Event fired when an extension is busy and receive a new call.");
i18n_add ( "Extension no answer");
i18n_add ( "Event fired when an extension has a new unanswered call.");
i18n_add ( "Extension DND");
i18n_add ( "Event fired when an extension has a new call and have DND enabled.");
i18n_add ( "Extension hangup");
i18n_add ( "Event fired when an extension hangup a call.");
i18n_add ( "Call blocked");
i18n_add ( "Event fired when a new call with a blocked number is received.");
i18n_add ( "Agent logged in");
i18n_add ( "Event fired when an agent log into a call queue.");
i18n_add ( "Agent paused");
i18n_add ( "Event fired when an agent pause on a call queue.");
i18n_add ( "Agent unpaused");
i18n_add ( "Event fired when an agent remove pause on a call queue.");
...
i18n_add ( "The validity is required.", "A validade é obrigatória.", "pt_BR");
...
i18n_add ( "Extension ringing", "Ramal tocando", "pt_BR");
i18n_add ( "Event fired when an extensions start ringing.", "Evento disparado quando extensões começam a chamar.", "pt_BR");
i18n_add ( "Extension answer", "Ramal atendeu", "pt_BR");
i18n_add ( "Event fired when an extension answer a call.", "Evento disparado quando um ramal atende uma ligação.", "pt_BR");
i18n_add ( "Extension busy", "Ramal ocupado", "pt_BR");
i18n_add ( "Event fired when an extension is busy and receive a new call.", "Evento disparado quando uma extensão está ocupada e recebe uma nova ligação.", "pt_BR");
i18n_add ( "Extension no answer", "Ramal não atende", "pt_BR");
i18n_add ( "Event fired when an extension has a new unanswered call.", "Evento disparado quando uma extensão não atende a uma ligação.", "pt_BR");
i18n_add ( "Extension DND", "Extensão em não perturbe", "pt_BR");
i18n_add ( "Event fired when an extension has a new call and have DND enabled.", "Evento disparado quando uma extensão recebe uma ligação e está em modo não perturbe.", "pt_BR");
i18n_add ( "Extension hangup", "Extensão desligou", "pt_BR");
i18n_add ( "Event fired when an extension hangup a call.", "Evento disparado quando uma extensão desliga uma ligação.", "pt_BR");
i18n_add ( "Call blocked", "Chamada bloqueada", "pt_BR");
i18n_add ( "Event fired when a new call with a blocked number is received.", "Evento disparado quando uma nova ligação de um número bloqueado é recebida.", "pt_BR");
i18n_add ( "Agent logged in", "Agente registrado", "pt_BR");
i18n_add ( "Event fired when an agent log into a call queue.", "Evento disparado quando um agente se registra em uma fila.", "pt_BR");
i18n_add ( "Agent paused", "Agente pausado", "pt_BR");
i18n_add ( "Event fired when an agent pause on a call queue.", "Evento disparado quando um agente entra em pausa em uma fila.", "pt_BR");
i18n_add ( "Agent unpaused", "Agente retornou", "pt_BR");
i18n_add ( "Event fired when an agent remove pause on a call queue.", "Evento disparado quando um agente retorna de uma pausa em uma fila.", "pt_BR");
