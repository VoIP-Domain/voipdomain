...
i18n_add ( "Are you sure you want to remove the notification %s (event \"%s\")?");
i18n_add ( "Notification remove");
i18n_add ( "Notification removed successfully!");
...
i18n_add ( "Notification changed successfully!");
...
i18n_add ( "Are you sure you want to remove the notification %s (event \"%s\")?", "Você tem certeza que deseja remover a notificação %s (evento \"%s\")?", "pt_BR");
i18n_add ( "Notification remove", "Remoção de notificação", "pt_BR");
i18n_add ( "Notification removed successfully!", "Notificação removida com sucesso!", "pt_BR");
...
i18n_add ( "Notification changed successfully!", "Notificação alterada com sucesso!", "pt_BR");
