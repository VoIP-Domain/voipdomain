...
framework_add_path ( "/config", "config_page", array ( "permissions" => array ( "Administrator")));
...
function config_page ( $output, $parameters)
{
  ...
  $output .= "    <li role=\"presentation\"><a class=\"nav-tablink\" href=\"#config_tab_geographical\">" . __ ( "Geographical") . "</a></li>\n";
  ...
  // Geographical panel
  $output .= "    <div role=\"tabpanel\" class=\"tab-pane fade in\" id=\"config_tab_geographical\">\n";

  // Add timezone selector
  $output .= "      <div class=\"form-group\">\n";
  $output .= "        <label class=\"control-label col-xs-2\">" . __ ( "Map") . "</label>\n";
  $output .= "        <div class=\"col-xs-10\">\n";
  $output .= "          <input type=\"hidden\" name=\"Offset\" id=\"config_offset\" value=\"\">\n";
  $output .= "          <img id=\"config_timezone_image\" src=\"/vendors/timezonepicker/images/living-600.jpg\" width=\"600\" height=\"300\" usemap=\"#config_timezone_map\" />\n";
  $output .= "          <img class=\"timezone-pin\" src=\"/vendors/timezonepicker/images/pin.png\" style=\"padding-top: 4px;\" />\n";
  $output .= "          <map name=\"config_timezone_map\" id=\"config_timezone_map\">\n";
  ...
  $output .= "      <div class=\"form-group\">\n";
  $output .= "        <label for=\"config_country\" class=\"control-label col-xs-2\">" . __ ( "Country") . "</label>\n";
  $output .= "        <div class=\"col-xs-10\">\n";
  $output .= "          <select name=\"Country\" id=\"config_country\" class=\"form-control\" data-placeholder=\"" . __ ( "Select default country") . "\"><option value=\"\"></option></select>\n";
  $output .= "        </div>\n";
  $output .= "      </div>\n";

  // Add timezone selector
  $output .= "      <div class=\"form-group\">\n";
  $output .= "        <label for=\"config_timezone\" class=\"control-label col-xs-2\">" . __ ( "Time zone") . "</label>\n";
  $output .= "        <div class=\"col-xs-10\">\n";
  $output .= "          <select name=\"TimeZone\" id=\"config_timezone\" class=\"form-control\" data-placeholder=\"" . __ ( "Select default time zone") . "\">\n";
  $output .= "            <option value=\"\"></option>\n";
  ...
  $output .= "        <div class=\"col-xs-10\">\n";
  $output .= "          <select name=\"Language\" class=\"form-control\" id=\"config_language\" data-placeholder=\"" . __ ( "Select default language") . "\"><option value=\"\"></option></select>\n";
  $output .= "        </div>\n";
  $output .= "      </div>\n";
  ...
  $output .= "        <div class=\"col-xs-10\">\n";
  $output .= "          <select name=\"Currency\" class=\"form-control\" id=\"config_currency\" data-placeholder=\"" . __ ( "Select default currency") . "\"><option value=\"\"></option></select>\n";
  $output .= "        </div>\n";
  $output .= "      </div>\n";

  // Close geographical panel
  $output .= "    </div>\n";
   ...
   */
  sys_addjs ( "$('#config_country').select2 (\n" .
              "{\n" .
              "  allowClear: true,\n" .
              ...
              "});\n" .
              "$('#config_timezone_image').timezonePicker (\n" .
              "{\n" .
              "  changeHandler: function ( timezoneName, countryName, offset)\n" .
              "                 {\n" .
              "                   if ( $('#config_country').val () != countryName)\n" .
              "                   {\n" .
              "                     $('#config_country').val ( countryName).trigger ( 'change');\n" .
              "                   }\n" .
              "                   if ( $('#config_timezone').val () != timezoneName)\n" .
              "                   {\n" .
              "                     $('#config_timezone').val ( timezoneName).trigger ( 'change');\n" .
              "                   }\n" .
              "                   $('#config_offset').val ( offset);\n" .
              "                 }\n" .
              "});\n" .
              "$('#config_timezone').select2 ().on ( 'change', function ( e)\n" .
              "{\n" .
              "  $('#config_timezone_image').timezonePicker ( 'updateTimezone', $('#config_timezone').val ());\n" .
              "});\n" .
              ...
              "});\n" .
              "$('.btn-addntpserver').data ( 'id', 0).on ( 'click', function ( event)\n" .
              "{\n" .
              ...
              "});\n" .
              "$('#config_length').select2 ();" .
              "$('#config_form').on ( 'fill', function ( event, data)\n" .
              "{\n" .
              "  $('#config_length').val ( data.NumbersLength).trigger ( 'change');\n" .
              ...
              "  $('#config_country').val ( data.Country['ISO3166-2']).trigger ( 'change');\n" .
              "  $('#config_timezone_image').timezonePicker ( 'updateTimezone', data.TimeZone);\n" .
              "  $('#config_timezone').val ( data.TimeZone).trigger ( 'change');\n" .
              "  $('#config_language').val ( data.Language.Code).trigger ( 'change');\n" .
              ...
              "    success: '" . __ ( "Configurations successfully changed!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/', true);\n" .
              "               }\n" .
...
framework_add_path ( "/config/permissions", "permissions_page", array ( "permissions" => array ( "Administrator")));
...
function permissions_page ( $output, $parameters)
{
  ...
  sys_addjs ( "$('#permissions_form input[type=\"radio\"]').labelauty ();\n" .
              ...
              "    success: '" . __ ( "Permissions changed successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/', true);\n" .
              "               }\n" .
...
framework_add_path ( "/config/plugins", "plugins_page", array ( "permissions" => array ( "Super-Administrator")));
...
function plugins_page ( $output, $parameters)
{
   ...
   */
  $output .= "<div id=\"plugins_add\" class=\"modal fade\" role=\"dialog\" aria-labelledby=\"plugins_add\" aria-hidden=\"true\">\n";
  $output .= "  <div class=\"modal-dialog modal-lg\">\n";
  $output .= "    <div class=\"modal-content\">\n";
  $output .= "      <div class=\"modal-header\">\n";
  $output .= "        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n";
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\">\n";
  $output .= "        <form class=\"form-horizontal\" id=\"plugins_add_form\" method=\"POST\" enctype=\"multipart/form-data\">\n";

  /**
   * Add import field
   */
  $output .= "        <div class=\"form-group\">\n";
  $output .= "          <label for=\"plugins_add_file\" class=\"control-label col-xs-2\">" . __ ( "Import") . "</label>\n";
   ...
   */
  $output .= "<div id=\"plugins_remove\" class=\"modal fade\" role=\"dialog\" aria-labelledby=\"plugins_remove\" aria-hidden=\"true\">\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "{\n" .
              "  e && e.preventDefault ();\n" .
              "  $('#plugins_add').modal ( 'show');\n" .
              "});\n" .
              "$('#plugins_add').on ( 'show.bs.modal', function ( e)\n" .
              "{\n" .
              "  $('#plugins_add tr.template-upload').remove ();\n" .
              "});\n" .
              "$('#plugins_add_form').fileupload (\n" .
              "{\n" .
              ...
              "  return false;\n" .
              "});\n" .
              "$('#plugins_add tbody.files').on ( 'click', 'button.remove', function ( e)\n" .
              "{\n" .
              ...
              "{\n" .
              "  e && e.preventDefault ();\n" .
              "  $('#plugins_remove_name').data ( 'dtrow', $('#datatables').data ( 'dt').rows ( { filter: 'applied'}).row ( $(this).parents ( 'tr').get ( 0)));\n" .
              "  $('#plugins_remove_name').data ( 'dirname', $(this).data ( 'dirname'));\n" .
              "  $('#plugins_remove button.del').prop ( 'disabled', false);\n" .
              "  $('#plugins_remove_name').html ( $(this).data ( 'name'));\n" .
              "  $('#plugins_remove_description').html ( $(this).data ( 'description'));\n" .
              "  $('#plugins_remove').modal ( 'show');\n" .
              ...
              "  {\n" .
              "    new PNotify ( { title: '" . __ ( "Plugin toggle") . "', text: '" . __ ( "Plugin toggled successfully!") . "', type: 'success'});\n" .
              "    var newData = VoIP.APIsearch ( { path: '/config/plugin', fields: 'Dirname,Name,Version,Description,Status'});\n" .
              "    $('#datatables').data ( 'dt').clear ();\n" .
              "    $('#datatables').data ( 'dt').rows.add ( newData);\n" .
              "    $('#datatables').data ( 'dt').draw ();\n" .
              ...
              "  });\n" .
              "});\n" .
              "$('#plugins_remove button.del').on ( 'click', function ( event)\n" .
              "{\n" .
              "  var l = Ladda.create ( this);\n" .
              "  l.start ();\n" .
              "  VoIP.rest ( '/config/plugin/' + encodeURIComponent ( $('#plugins_remove_name').data ( 'dirname')), 'DELETE').done ( function ( data, textStatus, jqXHR)\n" .
              "  {\n" .
              "    $('#plugins_remove').modal ( 'hide');\n" .
              "    new PNotify ( { title: '" . __ ( "Plugin removal") . "', text: '" . __ ( "Plugin removed successfully!") . "', type: 'success'});\n" .
              "    $('#plugins_remove_name').data ( 'dtrow').remove ().draw ();\n" .
              "  }).fail ( function ( jqXHR, textStatus, errorThrown)\n" .
              "  {\n" .
