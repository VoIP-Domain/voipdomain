 ...
 */
framework_add_filter ( "page_menu_reports_graph", "reports_menu");
...
{
  return array_merge ( (array) $buffer, array ( array ( "type" => "entry", "icon" => "fire", "href" => "/reports/graph/heat", "text" => __ ( "Heat map"))));
}
?>
