...
i18n_add ( "The privileged administrator name is required.", "O nome do administrador é obrigatório.", "pt_BR");
i18n_add ( "User name", "Usuário", "pt_BR");
i18n_add ( "Username of non-privileged user", "Nome do usuário não-privilegiado.", "pt_BR");
i18n_add ( "Admin name", "Administrador", "pt_BR");
i18n_add ( "Username of privileged adminstrator", "Nome do usuário administrador.", "pt_BR");
?>
