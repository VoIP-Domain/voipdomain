...
/**
 * VoIP Domain Htek equipments module filters. This module add the filter
 * calls related to supported Htek equipments.
 *
...
/**
 * Add Htek equipment's filters
 */
framework_add_filter ( "equipments_view_subpages", "equipments_htek_view_subpage");
framework_add_filter ( "equipments_configure_subpages", "equipments_htek_configure_subpage");
 ...
 */
function equipments_htek_view_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
  $extrausersmodels = array ( "uc902sp");
 ...
 * @return string Output of the generated page
 */
function equipments_htek_configure_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
