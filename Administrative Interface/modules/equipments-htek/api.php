...
/**
 * VoIP Domain Htek equipments module API. This module add the API calls
 * related to Htek equipments.
 *
...
framework_add_hook (
  "equipments_configure_uc902sp_sanitize",
  "equipments_configure_htek_userpass_sanitize"
);
framework_add_hook (
  "equipments_configure_uc902sp_validate",
  "equipments_configure_htek_userpass_validate"
);

/**
 * Function to extend equipments configuration sanitize of Htek models.
 *
 ...
 */
function equipments_configure_htek_userpass_sanitize ( $buffer, $parameters)
{
  global $_in;
...
/**
 * Function to extend equipments addition/edition validate of Htek models.
 *
 * @global array $_in Framework global configuration variable
 * @param string $buffer Buffer from plugin system if processed by other function
 *                       before
 ...
 * @return string Output of the generated page
 */
function equipments_configure_htek_userpass_validate ( $buffer, $parameters)
{
  global $_in;
