...
/**
 * VoIP Domain Fanvil equipments module filters. This module add the filter
 * calls related to supported Fanvil equipments.
 *
...
/**
 * Add Fanvil equipment's filters
 */
framework_add_filter ( "equipments_view_subpages", "equipments_fanvil_view_subpage");
framework_add_filter ( "equipments_configure_subpages", "equipments_fanvil_configure_subpage");
 ...
 */
function equipments_fanvil_view_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
  $extrausersmodels = array ( "x1sp", "x3sp");
 ...
 * @return string Output of the generated page
 */
function equipments_fanvil_configure_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
