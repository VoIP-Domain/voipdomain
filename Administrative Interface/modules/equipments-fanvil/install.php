...
function equipments_fanvil_install_db ( $buffer, $parameters)
{
  ...
  install_add_db_data ( "Equipments", array (
    array ( "UID" => "x1sp", "Vendor" => "Fanvil", "Model" => "X1S(P)", "Type" => "IPP", "SupportLevel" => "Basic", "Description" => "Entry-level IP Phone with 2 lines.", "Image" => "fanvil-x1sp.png", "VendorLink" => "https://fanvil.com/", "ModelLink" => "https://fanvil.com/products/p1/x/20220413/7344.html", "VideoSupport" => False, "AutoProvision" => True, "BLFSupport" => True, "Accounts" => 2, "Shortcuts" => 2, "Extensions" => 0, "ShortcutsPerExtension" => 0, "SupportedAudioCodecs" => "[\"G726\",\"OPUS\",\"ULAW\",\"ALAW\",\"G729\",\"ILBC\",\"G722\"]", "SupportedVideoCodecs" => "[]", "SupportedFirmwares" => "[{\"Version\":\"2.4.12.2\",\"Priority\":0,\"Available\":false,\"Files\":[{\"Filename\":\"x1sp-5914-RECOVERY-P0.18.23.1.23-2.4.12.2-1179T2022-08-05-21.56.57.z\",\"SHA256\":\"6c4f8e73aa3f9388997331b1057737285e4973dfe2533a1d1bbdd8cfbaaa5671\",\"Size\":10861354,\"Available\":false}]}]"),
    array ( "UID" => "x3sp", "Vendor" => "Fanvil", "Model" => "X3S(P)", "Type" => "IPP", "SupportLevel" => "Basic", "Description" => "Entry-level IP Phone with 2 lines.", "Image" => "fanvil-x3sp.png", "VendorLink" => "https://fanvil.com/", "ModelLink" => "https://fanvil.com/products/p1/x/20220413/7342.html", "VideoSupport" => False, "AutoProvision" => True, "BLFSupport" => True, "Accounts" => 2, "Shortcuts" => 2, "Extensions" => 0, "ShortcutsPerExtension" => 0, "SupportedAudioCodecs" => "[\"G726\",\"ULAW\",\"ALAW\",\"G729\",\"G722\"]", "SupportedVideoCodecs" => "[]", "SupportedFirmwares" => "[{\"Version\":\"2.4.12.2\",\"Priority\":0,\"Available\":false,\"Files\":[{\"Filename\":\"x3s2.14.0.7387T20220824101038.z\",\"SHA256\":\"da255a2b27a95adfa845f01796c8a0a7203bd78d8a1323faf8e66ce5e25c175b\",\"Size\":3922923,\"Available\":false}]}]")
  ));
