...
function ivrs_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove the IVR %s (%s)?"), "<span id=\"ivr_delete_name\"></span>", "<span id=\"ivr_delete_description\"></span>") . "</p><input type=\"hidden\" id=\"ivr_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "IVR removal") . "', text: '" . __ ( "IVR removed successfully!") . "', type: 'success'});\n" .
...
function ivrs_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "var flowchart = $('#ivr_add_workflow');\n" .
              ...
              "    success: '" . __ ( "IVR added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
...
function ivrs_clone_function ( $buffer, $parameters)
{
  ...
  sys_addjs ( "VoIP.rest ( '/ivrs/' + encodeURIComponent ( VoIP.parameters.id), 'GET').done ( function ( data, textStatus, jqXHR)\n" .
              ...
              "}).fail ( function ( jqXHR, textStatus, errorThrown)\n" .
              "{\n" .
              "  new PNotify ( { title: '" . __ ( "IVR cloning") . "', text: '" . __ ( "Error retrieving IVR data!") . "', type: 'error'});\n" .
              "});\n");
}
...
function ivrs_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "var flowchart = $('#ivr_edit_workflow');\n" .
              ...
              "    success: '" . __ ( "IVR edited successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/ivrs', true);\n" .
              "               }\n" .
