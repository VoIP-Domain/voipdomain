...
function framework_page_generate ( $content)
{
  ...
  $body .= "              <span class=\"hidden-xs\">" . strip_tags ( $_in["session"]["Data"]["Name"]) . "</span>\n";
  $body .= "            </a>\n";
  ...
  $body .= "                  <a href=\"/users/" . $_in["session"]["Data"]["ID"] . "/edit\" class=\"btn btn-default btn-flat\">" . __ ( "Profile") . "</a>\n";
  $body .= "                </div>\n";
  ...
  $body .= "          <p>" . strip_tags ( $_in["session"]["Data"]["Name"]) . "</p>\n";
  ...
  {
    $footer .= "                          VoIP.interface.addObject ( { 'object': '" . addslashes ( $object["object"]) . "', 'path': '" . addslashes ( array_key_exists ( "path", $object) ? $object["path"] : "") . "', 'type': '" . addslashes ( array_key_exists ( "type", $object) ? $object["type"] : "") . "', 'icon': '" . addslashes ( $object["icon"]) . "', 'label': '" . addslashes ( $object["label"]) . "', 'text': { 'singular': '" . addslashes ( $object["text"]["singular"]) . "', 'plural': '" . addslashes ( $object["text"]["plural"]) . "'}});\n";
  }
  $footer .= "                        }\n";
  $footer .= "            }\n";
  $footer .= "          ],\n";
  ...
  $footer .= "                    user: '" . addslashes ( strip_tags ( $_in["session"]["Data"]["Username"])) . "',\n";
  $footer .= "                    name: '" . addslashes ( strip_tags ( $_in["session"]["Data"]["Name"])) . "',\n";
  $footer .= "                    uid: '" . addslashes ( strip_tags ( $_in["session"]["Data"]["ID"])) . "',\n";
...
function login_page_generate ( $buffer, $parameters)
{
  ...
  $body .= "    </div>\n";
  $body .= "  </div>\n";
  $body .= "  <div class=\"background\"><img src=\"/img/bg-login.jpg\" alt=\"\"></div>\n";
