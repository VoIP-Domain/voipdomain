...
function extensions_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove extension %s (%s)?"), "<span id=\"extension_delete_name\"></span>", "<span id=\"extension_delete_extension\"></span>") . "</p><input type=\"hidden\" id=\"extension_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Extension removal") . "', text: '" . __ ( "Extension removed successfully!") . "', type: 'success'});\n" .
...
function extensions_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#extension_add_number').mask ( '0#').on ( 'change', function ()\n" .
              ...
              "    success: '" . __ ( "Extension added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
...
function extensions_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#extension_edit_number').mask ( '0#').on ( 'change', function ()\n" .
              ...
              "    success: '" . __ ( "Extension successfully changed!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/extensions', true);\n" .
              "               }\n" .
