...
function queues_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Name,Strategy,StrategyText",
    "PermittedFields" => "ID,Description,Name,Strategy,StrategyText"
  );
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New queue added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The queue was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
framework_add_hook (
  ...
  array (
    "response" => array (
      200 => array (
        "description" => __ ( "The agent was successfully added to the queue.")
      ),
      201 => array (),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
...
framework_add_hook (
  ...
  array (
    "response" => array (
      200 => array (
        "description" => __ ( "The agent was successfully removed from the queue.")
      ),
      201 => array (),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
...
framework_add_hook (
  ...
  array (
    "response" => array (
      200 => array (
        "description" => __ ( "The agent was successfully paused at the queue.")
      ),
      201 => array (),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
...
framework_add_hook (
  ...
  array (
    "response" => array (
      200 => array (
        "description" => __ ( "The agent was successfully resumed at the queue.")
      ),
      201 => array (),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
