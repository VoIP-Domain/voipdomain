...
function queues_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove the queue %s (%s)?"), "<span id=\"queue_delete_name\"></span>", "<span id=\"queue_delete_description\"></span>") . "</p><input type=\"hidden\" id=\"queue_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Queue removal") . "', text: '" . __ ( "Queue removed successfully!") . "', type: 'success'});\n" .
...
function queues_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#queue_add_strategy').select2 ( { allowClear: true });\n" .
              ...
              "    success: '" . __ ( "Queue added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
...
function queues_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#queue_edit_strategy').select2 ( { allowClear: true });\n" .
              ...
              "    success: '" . __ ( "Queue changed successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/queues', true);\n" .
              "               }\n" .
