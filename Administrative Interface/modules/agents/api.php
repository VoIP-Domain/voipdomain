...
function agents_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Name,Code",
    "PermittedFields" => "ID,Name,Code"
  );
   ...
   */
  $data = array ();
  if ( array_key_exists ( "Code", $parameters) && ! preg_match ( "^[0-9]{4}$", $parameters["Code"]))
  {
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system call center agent was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
