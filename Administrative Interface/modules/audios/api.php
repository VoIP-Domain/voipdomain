...
function audios_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Description,Filename,Uses",
    "PermittedFields" => "ID,Description,Filename,Uses"
  );
...
function audios_download ( $buffer, $parameters)
{
  ...
  if ( array_key_exists ( "Chunked", $parameters) && (int) $parameters["Chunked"] > 0)
  {
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New system audio file added successfully.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
function audios_add ( $buffer, $parameters)
{
   ...
   */
  if ( ! @file_put_contents ( $_in["general"]["storagedir"] . "/sounds/" . $parameters["Filename"], base64_decode ( $parameters["Filecontent"])))
  {
    header ( $_SERVER["SERVER_PROTOCOL"] . " 503 Service Unavailable");
    exit ();
  }
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system audio file was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
