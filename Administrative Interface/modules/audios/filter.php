...
/**
 * VoIP Domain audio module filters. This module add the filter calls related
 * to audio.
 *
 ...
 * Add audio's filters
 */
framework_add_filter ( "page_menu_registers", "audios_menu");
framework_add_filter ( "get_audios", "get_audios");
...
/**
 * Function to get audios filtered by ID, name or number.
 *
 ...
 */
function get_audios ( $buffer, $parameters)
{
  global $_in;
