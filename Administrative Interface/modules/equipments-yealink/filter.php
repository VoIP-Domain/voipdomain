...
/**
 * VoIP Domain Yealink equipments module filters. This module add the filter
 * calls related to supported Yealink equipments.
 *
...
/**
 * Add Yealink equipment's filters
 */
framework_add_filter ( "equipments_view_subpages", "equipments_yealink_view_subpage");
framework_add_filter ( "equipments_configure_subpages", "equipments_yealink_configure_subpage");
 ...
 */
function equipments_yealink_view_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
  $extrausersmodels = array ( "t18p", "t19pe2", "t20p", "t21p", "t21pe2", "t22p", "t23p", "t23g", "t26p", "t27p", "t27g", "t29g", "t30p", "t31", "t31p", "t31g", "t38g", "t40p", "t46s", "t48s", "cp920", "vp530");
  foreach ( $extrausersmodels as $model)
  {
    ...
    $output .= "        <label for=\"equipment_view_" . $model . "_username\" class=\"control-label col-xs-2\">" . __ ( "User name") . "</label>\n";
    $output .= "        <div class=\"col-xs-10\">\n";
    $output .= "          <input type=\"text\" name=\"" . strtoupper ( $model) . "_Username\" class=\"form-control\" id=\"equipment_view_" . $model . "_username\" placeholder=\"" . __ ( "Username of non-privileged user") . "\" disabled=\"disabled\" />\n";
    $output .= "        </div>\n";
    $output .= "      </div>\n";
    ...
    $output .= "      <div class=\"form-group\">\n";
    $output .= "        <label for=\"equipment_view_" . $model . "_adminname\" class=\"control-label col-xs-2\">" . __ ( "Admin name") . "</label>\n";
    $output .= "        <div class=\"col-xs-10\">\n";
    $output .= "          <input type=\"text\" name=\"" . strtoupper ( $model) . "_Adminname\" class=\"form-control\" id=\"equipment_view_" . $model . "_adminname\" placeholder=\"" . __ ( "Username of privileged adminstrator") . "\" disabled=\"disabled\" />\n";
    $output .= "        </div>\n";
    $output .= "      </div>\n";
     ...
     */
    $buffer["js"]["onshow"][$model] = "      $('#equipment_view_" . $model . "_username').val ( data.ExtraSettings.User.Name);\n" .
                                      "      $('#equipment_view_" . $model . "_userpass').val ( data.ExtraSettings.User.Password);\n" .
                                      "      $('#equipment_view_" . $model . "_adminname').val ( data.ExtraSettings.Admin.Name);\n" .
                                      "      $('#equipment_view_" . $model . "_adminpass').val ( data.ExtraSettings.Admin.Password);\n";
 ...
 * @return string Output of the generated page
 */
function equipments_yealink_configure_subpage ( $buffer, $parameters)
{
  /**
   * Add extra fields for administrator and user name and password
   */
  ...
  foreach ( $extrausersmodels as $model)
  {
    ...
    // Add equipment normal user name field
    $output .= "      <div class=\"form-group\">\n";
    $output .= "        <label for=\"equipment_configure_" . $model . "_username\" class=\"control-label col-xs-2\">" . __ ( "User name") . "</label>\n";
    $output .= "        <div class=\"col-xs-10\">\n";
    $output .= "          <input type=\"text\" name=\"" . strtoupper ( $model) . "_Username\" class=\"form-control\" id=\"equipment_configure_" . $model . "_username\" placeholder=\"" . __ ( "Username of non-privileged user") . "\" />\n";
    $output .= "        </div>\n";
    $output .= "      </div>\n";
    ...
    // Add equipment admin name field
    $output .= "      <div class=\"form-group\">\n";
    $output .= "        <label for=\"equipment_configure_" . $model . "_adminname\" class=\"control-label col-xs-2\">" . __ ( "Admin name") . "</label>\n";
    $output .= "        <div class=\"col-xs-10\">\n";
    $output .= "          <input type=\"text\" name=\"" . strtoupper ( $model) . "_Adminname\" class=\"form-control\" id=\"equipment_configure_" . $model . "_adminname\" placeholder=\"" . __ ( "Username of privileged adminstrator") . "\" />\n";
    $output .= "        </div>\n";
    $output .= "      </div>\n";
     ...
     * Add configure form JavaScript code
     */
    $buffer["js"]["onshow"][$model] = "      $('#equipment_configure_" . $model . "_username').val ( data.ExtraSettings.User.Name);\n" .
                                      "      $('#equipment_configure_" . $model . "_userpass').val ( data.ExtraSettings.User.Password);\n" .
                                      "      $('#equipment_configure_" . $model . "_adminname').val ( data.ExtraSettings.Admin.Name);\n" .
                                      "      $('#equipment_configure_" . $model . "_adminpass').val ( data.ExtraSettings.Admin.Password);\n";
    $buffer["js"]["init"][] = "$('#equipment_configure_tab_" . $model . " .btn-random').on ( 'click', function ( event)\n" .
                              ...
                              "    formData.ExtraSettings.User.Name = formData['" . strtoupper ( $model) . "_Username'];\n" .
                              "    formData.ExtraSettings.User.Password = formData['" . strtoupper ( $model) . "_Userpass'];\n" .
                              "    formData.ExtraSettings.Admin = new Object ();\n" .
                              "    formData.ExtraSettings.Admin.Name = formData['" . strtoupper ( $model) . "_Adminname'];\n" .
                              "    formData.ExtraSettings.Admin.Password = formData['" . strtoupper ( $model) . "_Adminpass'];\n" .
                              "  }\n" .
                              "  delete ( formData['" . strtoupper ( $model) . "_Username']);\n" .
                              "  delete ( formData['" . strtoupper ( $model) . "_Userpass']);\n" .
                              "  delete ( formData['" . strtoupper ( $model) . "_Adminname']);\n" .
