...
i18n_add ( "The non-privileged user name is required.");
i18n_add ( "The privileged administrator name is required.");
i18n_add ( "The password is required.");
i18n_add ( "User name");
i18n_add ( "Username of non-privileged user");
i18n_add ( "Admin name");
i18n_add ( "Username of privileged adminstrator");
i18n_add ( "Extras");
...
i18n_add ( "The non-privileged user name is required.", "O nome do usuário não-privilegiado é obrigatório.", "pt_BR");
i18n_add ( "The privileged administrator name is required.", "O nome do administrador privilegiado é obrigatório.", "pt_BR");
i18n_add ( "The password is required.", "A senha é obrigatória.", "pt_BR");
i18n_add ( "User name", "Nome do usuário", "pt_BR");
i18n_add ( "Username of non-privileged user", "Nome do usuário não-privilegiado", "pt_BR");
i18n_add ( "Admin name", "Nome do administrador", "pt_BR");
i18n_add ( "Username of privileged adminstrator", "Nome do administrador privilegiado", "pt_BR");
i18n_add ( "Extras", "Extras", "pt_BR");
i18n_add ( "Generate random password", "Gerar senha randômica", "pt_BR");
?>
