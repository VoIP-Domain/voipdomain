...
function blocks_search_page ( $buffer, $parameters)
{
  ...
  $output .= "      </div>\n";
  $output .= "      <div class=\"modal-body\"><p>" . sprintf ( __ ( "Are you sure you want to remove the block %s (%s)?"), "<span id=\"block_delete_description\"></span>", "<span id=\"block_delete_number\"></span>") . "</p><input type=\"hidden\" id=\"block_delete_id\" value=\"\"></div>\n";
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "Block removal") . "', text: '" . __ ( "Block removed successfully!") . "', type: 'success'});\n" .
...
function blocks_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#block_add_number').mask ( '+0#');\n" .
              ...
              "    success: '" . __ ( "Block added successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
...
function blocks_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#block_edit_number').mask ( '+0#');\n" .
              ...
              "    success: '" . __ ( "Block changed successfully!") . "',\n" .
              "    onsuccess: function ()\n" .
              "               {\n" .
              "                 VoIP.path.call ( '/blocks', true);\n" .
              "               }\n" .
