...
function equipments_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ID,Vendor,Model",
    "PermittedFields" => "ID,UID,Vendor,Model,Active,Type,VideoSupport,AutoProvision,BLFSupport,Accounts,Shortcuts,Extensions,ShortcutsPerExtension,SupportLevel"
  );
...
function equipments_view ( $buffer, $parameters)
{
  ...
  if ( ! $equipment = $result->fetch_assoc ())
  {
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      200 => array (
        "description" => __ ( "The system equipment was successfully updated.")
      ),
      422 => array (
        "description" => __ ( "An error occurred while processing the request. An object with field name and a text error message will be returned to all inconsistency found."),
        "schema" => array (
...
framework_add_hook (
  ...
  array (
    ...
    "response" => array (
      201 => array (
        "description" => __ ( "New equipment firmware file added successfully."),
        "schema" => array (
          "type" => "object",
          "properties" => array (
            "Active" => array (
...
framework_add_hook (
  ...
  array (
    "response" => array (
      204 => array (
        "description" => __ ( "Equipment firmware file removed successfully."),
        "schema" => array (
          "type" => "object",
          "properties" => array (
            "Active" => array (
