...
function users_search_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#datatables').data ( 'dt', $('#datatables').DataTable (\n" .
              ...
              "    new PNotify ( { title: '" . __ ( "User removal") . "', text: '" . __ ( "User removed successfully!") . "', type: 'success'});\n" .
...
function users_add_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#user_add_form input[type=checkbox]').bootstrapToggle ( { on: '" . __ ( "Yes") . "', off: '" . __ ( "No") . "'});\n" .
              ...
              "{\n" .
              "  var formData = $('#user_add_form').data ( 'formData');\n" .
              "  if ( ! formData.hasOwnProperty ( 'Permissions'))\n" .
              "  {\n" .
              "    formData.Permissions = new Array ();\n" .
              "  }\n" .
              "  if ( $('#user_add_administrator').prop ( 'checked'))\n" .
              "  {\n" .
              "    formData.Permissions.push ( 'Administrator');\n" .
              "  }\n" .
              "  delete ( formData.Administrator);\n" .
              "  $('#user_add_form').data ( 'formData', formData);\n" .
              "});");
...
function users_clone_function ( $buffer, $parameters)
{
  ...
  sys_addjs ( "VoIP.rest ( '/users/' + encodeURIComponent ( VoIP.parameters.id), 'GET').done ( function ( data, textStatus, jqXHR)\n" .
              ...
              "    $('#user_add_administrator').bootstrapToggle ( ( $.inArray ( 'Administrator', data.Permissions) != -1 ? 'on' : 'off'));\n" .
              ( framework_has_hook ( "users_clone_inject") ? framework_call ( "users_clone_inject") : "") .
              "    $('#user_add_name').focus ();\n" .
              "  });\n" .
              "}).fail ( function ( jqXHR, textStatus, errorThrown)\n" .
              "{\n" .
...
function users_view_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#user_view_form input[type=checkbox]').bootstrapToggle ( { on: '" . __ ( "Yes") . "', off: '" . __ ( "No") . "'});\n" .
              ...
              "  $('#user_view_administrator').bootstrapToggle ( 'enable').bootstrapToggle ( ( $.inArray ( 'Administrator', data.Permissions) != -1 ? 'on' : 'off')).bootstrapToggle ( 'disable');\n" .
              "  $('#user_view_sfa').bootstrapToggle ( 'enable').bootstrapToggle ( ( data.SFA ? 'on' : 'off')).bootstrapToggle ( 'disable');\n" .
...
function users_edit_page ( $buffer, $parameters)
{
  ...
  sys_addjs ( "$('#user_edit_form input[type=checkbox]').bootstrapToggle ( { on: '" . __ ( "Yes") . "', off: '" . __ ( "No") . "'});\n" .
              ...
              "  $('#user_edit_administrator').bootstrapToggle ( ( $.inArray ( 'Administrator', data.Permissions) != -1 ? 'on' : 'off'));\n" .
	      ...
	      "    });\n" .
              ...
              "}).on ( 'formFilter', function ()\n" .
              "{\n" .
              "  var formData = $('#user_edit_form').data ( 'formData');\n" .
              "  if ( ! formData.hasOwnProperty ( 'Permissions'))\n" .
              "  {\n" .
              "    formData.Permissions = new Array ();\n" .
              "  }\n" .
              "  if ( $('#user_edit_administrator').prop ( 'checked'))\n" .
              "  {\n" .
              "    formData.Permissions.push ( 'Administrator');\n" .
              "  }\n" .
              "  delete ( formData.Administrator);\n" .
              "  formData.SFA = $('#user_edit_sfa').prop ( 'checked');\n" .
              "  $('#user_edit_form').data ( 'formData', formData);\n" .
              "});");
