    ...
    "requests" => array (
      ...
      "properties" => array (
        ...
        "Fields" => array (
          ...
          "default" => "ISO4217,Code,Name,Symbol,MajorSingle,MinorSingle,MajorPlural,MinorPlural,Digits,Decimals",
          "example" => "ISO4217,Code,Name,Symbol,NativeSymbol,MajorSingle,MinorSingle,MajorPlural,MinorPlural,Digits,Decimals,NumToBasic"
        )
      )
    ),
    "response" => array (
...
function currencies_search ( $buffer, $parameters)
{
  ...
  $parameters["function"] = array (
    "DefaultFields" => "ISO4217,Code,Name,Symbol,MajorSingle,MinorSingle,MajorPlural,MinorPlural,Digits,Decimals",
    "PermittedFields" => "ISO4217,Code,Name,NameEN,Symbol,NativeSymbol,MajorSingle,MajorSingleEN,MinorSingle,MinorSingleEN,MajorPlural,MajorPluralEN,MinorPlural,MinorPluralEN,Digits,Decimals,NumToBasic"
  );
...
function currencies_view ( $buffer, $parameters)
{
  ...
  $data = api_filter_entry ( array ( "ISO4217", "Code", "Name", "NameEN", "Symbol", "NativeSymbol", "MajorSingle", "MajorSingleEN", "MinorSingle", "MinorSingleEN", "MajorPlural", "MajorPluralEN", "MinorPlural", "MinorPluralEN", "Digits", "Decimals", "NumToBasic"), $currency);
