...
var timezoneName=$(areaElement).attr('data-timezone');var countryName=$(areaElement).attr('data-country');var offset=$(areaElement).attr('data-offset');if(opts.target){if(timezoneName)$(opts.target).val(timezoneName);}
if(opts.countryTarget){if(countryName)$(opts.countryTarget).val(countryName);}
if(typeof changeHandler==='function'){changeHandler(timezoneName,countryName,offset);}
