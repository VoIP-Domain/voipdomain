...
* Akshay Kumar - alias [@akshay-zz](https://github.com/akshay-zz) - for implementing element double click trigger event.
* Alisson Pelizaro - alias [@alissonpelizaro](https://github.com/alissonpelizaro) - for adding linkId on return to getLinks() method.
...
* __onOperatorDoubleClick (default: function returning true):__ Callback method. Called when an operator is double clicked. It should return a boolean. Returning `false` cancels the selection. Parameters are:
  * __operatorId:__ ID of the operator.
