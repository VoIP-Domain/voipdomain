...
/**
 * VoIP Domain sample items module filters. This module add the filter calls
 * related to sample items.
 *
 ...
 * Add block's filters
 */
framework_add_filter ( "page_menu_registers", "sampleitems_menu");
